      ...
      <div className="w-full">
        ...
        <div className="space-y-6 text-sm md:text-base leading-relaxed text-gray-800 text-left md:text-justify">
          ...
          <div className="space-y-6">
           <h2 className="text-xl font-bold text-gray-800"> SMS/MMS Consent and Terms</h2>
          <p>
            By providing and opting in your mobile phone number, you consent to receive periodic SMS/MMS messages from Rose Kitchen. These messages may include important updates, exclusive offers, promotions tailored to your interests, and other communications related to our products and services.
          </p>

          <h2 className="text-xl font-bold text-gray-800">Providing Your Telephone Number and Notification Obligations</h2>
          <p> 
            Accuracy: You affirm that the mobile number you provide is accurate and current.<br/>
            Ownership: You represent that you are the authorized subscriber or owner of the telephone number.<br/>
            Notification: If your contact information changes, you agree to notify us immediately by emailing info@rosekitchen.net before the change takes effect.
          </p>

          <h2 className="text-xl font-bold text-gray-800"> Consent to Receive Automated Communications</h2>
          
          <p>
            By voluntarily providing your telephone number(s), you explicitly consent to receive recurring automated text messages from Rose Kitchen regarding our products, services, offers, promotions, and your relationship with us.
            <br/><br/>
            <strong>Note:</strong> Consent to receive these messages is not a condition of purchase. Standard message and data rates may apply.
          </p>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-gray-800"> Opt-Out Instructions</h2>
         <p>            SMS/MMS: To unsubscribe from our SMS/MMS messages at any time, text STOP in response to any message.<br/>
            Email: Alternatively, you can send an email to info@rosekitchen.net indicating that you wish to opt out of text messages. You will receive a final message confirming your opt-out.
          </p>

        </div>

        <div className="space-y-4">
          <h2 className="text-xl font-bold text-gray-800"> Privacy Assurance</h2>
          <p>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-gray-800"> Assistance</h2>
          <p>
            For help:<br/>
          ...
          <h2 className="text-xl font-bold text-gray-800"> Carrier Participation</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-800"> Data Collection and Use</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-800"> Service Modifications and Termination</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-800"> Participation Requirements</h2>
          <p>
